...
{
    public class LiquidQuantumFilterDualConfig:IBuildingConfig
    {
		public static string UPPERID { get { return ID.ToUpperInvariant(); } }
		public const string NAME = "Quantum Liquid Intake/Outlet";
		public static string DESC = "Stores "+STRINGS.UI.FormatAsLink("liquids", "ELEMENTS_LIQUID") +" in a "+ STRINGS.UI.FormatAsLink(LiquidQuantumCompressorConfig.NAME, LiquidQuantumCompressorConfig.UPPERID) + ", and receives a user-selected " + STRINGS.UI.FormatAsLink("liquid", "ELEMENTS_LIQUID") + " type from a " + STRINGS.UI.FormatAsLink(LiquidQuantumCompressorConfig.NAME, LiquidQuantumCompressorConfig.UPPERID) + ".";
		public const string ID = "LiquidQuantumFilterDual";
		...
		{
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 1, 2, "valveliquid_logic_kanim", 30, 10f, QuantumStorage.DualPortCost, QuantumStorage.DualPortMats,
